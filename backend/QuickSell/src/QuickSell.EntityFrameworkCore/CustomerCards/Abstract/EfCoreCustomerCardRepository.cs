...
{
    public abstract class EfCoreCustomerCardRepository : EfCoreRepository<QuickSellDbContext, CustomerCard , Guid>, ICustomerCardRepository
    {
        ...
        public async Task<List<CustomerCard>> GetListAsync(
            ...
            ,int? taxNoMin= null 
            ,int? taxNoMax= null 
            ,int? riskLimitMin= null 
            ,int? riskLimitMax= null 
