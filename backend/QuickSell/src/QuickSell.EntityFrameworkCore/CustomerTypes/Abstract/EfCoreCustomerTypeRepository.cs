...
{
    public abstract class EfCoreCustomerTypeRepository : EfCoreRepository<QuickSellDbContext, CustomerType , Guid>, ICustomerTypeRepository
    {
        public EfCoreCustomerTypeRepository(IDbContextProvider<QuickSellDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
